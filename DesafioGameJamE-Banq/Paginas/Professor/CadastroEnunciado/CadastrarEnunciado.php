...
<body>
	...
	?>
	<form action="./InserirEnunciadoBanco.php" method="POST" id="formulario">
		<h1>Cadastro de Enunciados e Questões</h1>

		<div class="section">
			<h2>Enunciado</h2>
			<label for="titulo" class="FormsItens">Título do Enunciado:</label>
			<input type="text" id="tituloEnunciado" name="tituloEnunciado" class="FormsItens" maxlength="100" required>

			<label for="textoEnunciado" class="FormsItens">Texto do Enunciado:</label>
			<textarea id="texto" name="textoEnunciado" class="FormsItens" rows="5" required></textarea>
		</div>

...
<body>
	<?php
		...
		$idCurso = sanitizarDados($_POST['id_curso']);
		...
		cadastrarDisciplina($idCurso, $nomeDisciplina, $ementaDisciplina, $objetivosAprendizagem);

	?>
	<h1>Disciplina Cadastrada com sucesso</h1>

...
<body>
	<?php
		...
		$nomeCoordenador = sanitizarDados($_POST['nomeCoordenador']);
		...
		cadastrarCoordenador($nomeCoordenador, $dataNascimento, $emailInstitucional, $senha);

	?>
	<h1>Coordenador cadastrado com sucesso</h1>
